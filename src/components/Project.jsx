...
const CustomButton = ({ children, onClick, className = "", style = {}, asChild, ...props }) => {
  const baseClasses = "px-6 py-3 rounded-md font-medium transition-all duration-300 hover:-translate-y-0.5 cursor-pointer border-0 outline-none";

  if (asChild && children?.type === "a") {
    return (
      <a {...children.props} className={`${baseClasses} ${className} inline-block text-center`} style={style}>
...
const Projects = () => {
    ...
    fullStack: [
      {
        ...
        description: "A real-time chat application built with authentication and socket-based communication.",
        image: chat,
      ...
      },
      {
        ...
        description: "A blogging platform with authentication, CRUD features, and modern UI.",
        image: blog,
      ...
      },
      {
        ...
        description: "A finance management app built with Redux for state management.",
        image: expense,
      ...
      },
      {
        ...
        description: "A secure authentication system with signup, login, and email verification.",
        image: auth,
      ...
      },
      {
        ...
        description: "A web application to create, preview, and copy custom CSS gradients with ease.",
        image: gradient,
      ...
      },
      {
        ...
        description: "A simple inventory tracking app to manage stock and products.",
        image: inventory,
      ...
      },
      {
        ...
        description: "A system to manage customer accounts, transactions, and banking operations.",
        image: bank,
    ...
    webDesign: [
      {
        ...
        description: "A sleek and modern website built using HTML, CSS, and JavaScript with smooth animations.",
        image: html,
      ...
      },
      {
        id: 9,
        title: "Nexcent",
        description: "A creative portfolio website with stunning visuals and clean UI.",
        image: nexcent,
      ...
      },
      {
        ...
        description: "A small React project demonstrating component reusability and hooks.",
        image: react,
  ...
  return (
    <section id="projects" className="py-20 px-4" style={{ background: "var(--bg-secondary)" }}>
        ...
        <div className="md:hidden space-y-16">
          {tabs.map((tab) => (
            <div key={tab.id} className="mb-16">
              <h3 className="text-2xl font-semibold text-center mb-8 relative" style={{ color: "var(--text-primary)" }}>
                {tab.label}
                <div className="absolute bottom-[-10px] left-1/2 transform -translate-x-1/2 w-15 h-0.5 rounded-full" style={{ background: "linear-gradient(90deg, var(--primary-color), var(--secondary-color))" }} />
              </h3>
      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        <div className="flex items-center justify-between mt-auto pt-4 border-t" style={{ borderColor: "rgba(255, 255, 255, 0.1)" }}>
          <div className="flex flex-wrap gap-2">
            {project.tech && project.tech.slice(0, 2).map((tech, i) => (
              <span
                key={i}
